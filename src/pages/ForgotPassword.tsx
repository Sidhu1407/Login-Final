...
import { Leaf, ArrowRight, Phone, ArrowLeft, Sprout } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-amber-50 flex flex-col items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-500 transform hover:scale-[1.01]">
          ...
          {/* Form */}
          <div className="p-8">
            <h2 className="text-2xl font-semibold text-green-800 mb-6">Forgot your password?</h2>
            
            <p className="text-gray-600 mb-6">
              {!isSubmitted 
                ? "Enter your mobile number to reset your password." 
                : "Please check the password reset text message."}
            </p>
            ...
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  <div className={`flex items-center border-2 rounded-lg overflow-hidden transition-all ${
                    isMobileFocused ? "border-green-500 bg-green-50" : "border-gray-300"
                  }`}>
                    <span className="pl-3">
                      <Phone size={18} className={`${isMobileFocused ? "text-green-500" : "text-gray-400"}`} />
                    </span>
                    <input
                      id="mobile"
                      type="tel"
              ...
              <div className="text-center p-6 bg-green-50 rounded-lg">
                ...
                <h3 className="text-lg font-medium text-gray-800 mb-2">Check your message</h3>
                <p className="text-gray-600 mb-4">
                Password reset text message <strong>{mobileNumber}</strong> Sent to Number
                </p>
                <button
