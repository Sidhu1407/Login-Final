...
import { Leaf, Sprout, Lock, Phone, Eye, EyeOff, ArrowRight, User, ChevronLeft } from 'lucide-react';
...
const AnimatedAuth = () => {
  ...
  }, [isMobileFocused, isPasswordFocused, isNameFocused, isPhoneFocused]);
            ...
            >
              <Leaf 
                ...
                className={`text-green-200 transition-all duration-500 ${
                  (isMobileFocused || isPasswordFocused || isNameFocused || isPhoneFocused) ? "animate-pulse" : ""
                }`} 
              />
            </div>
